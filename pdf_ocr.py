...
if __name__ == "__main__":
    load_dotenv()
    parser = argparse.ArgumentParser(description="Process PDF OCR")
    parser.add_argument("pdf_path", help="Path to the PDF file")
    parser.add_argument("--api-key", help="API key for Mistral", default=os.getenv("MISTRAL_API_KEY"))
    args = parser.parse_args()

    if args.api_key is None:
        exit("API_KEY not provided. Please set it in the .env file or pass via --api-key.")
